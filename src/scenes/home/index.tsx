...
const Home = ({setSelctedPage}: Props) => {
        ...
        className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6">
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                <motion.div
                    ...
                    <ActionButton setSelctedPage={setSelctedPage}>
                        Join Now
                    </ActionButton>
                    <AnchorLink
            ...
            {/* IMAGE */}
            <div className="flex basis-3/5 justify-center md:z-0 md:ml-40 md:mt-16 md:justify-items-end">
